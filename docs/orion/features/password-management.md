...
![macOS Save Password](./media/macos_passwords_1_save_password.png)
...
![macOS Fill Password](./media/macos_passwords_2_fill_password.png)
...
![macOS Passwords Menu](./media/macos_passwords_3_passwords_menu.png)

This will open the Passwords window which will be locked to protect your privacy. Use your macOS password to unlock it.

![macOS Passwords Window - Locked](./media/macos_passwords_4_passwords_window_locked.png)
...
![macOS Passwords Window - List](./media/macos_passwords_5_passwords_window_list.png)
...
![macOS Passwords Window - Options](./media/macos_passwords_6_passwords_window_options.png)
...
![Importing from Safari](./media/macos_import_from_safari.png){width=418 height=464}
...
![Safari Import](./media/macos_safari_import.png){width=482 height=353}

4. Select the passwords file you exported in step 1.

![Safari Import](./media/macos_safari_import_csv.png){width=490 height=458}
...
![Open macOS System Settings](./media/macos_open_system_settings_menu.png){width=226 height=304}

2. Open **iCloud**.

![Open macOS System Settings](./media/macos_appleid_button.png){width=717 height=555}

3. Open **Passwords**.

![Open macOS System Settings](./media/macos_appleid_passwords.png){width=717 height=334}

4. Enable **Sync this Mac**.

![Open macOS System Settings](./media/macos_icloud_keychain.png){width=471 height=281}
...
![iOS iCloud Settings](./media/ios_icloud.png)

![iOS iCloud Keychain Settings](./media/ios_keychain.png)
...
![iPadOS iCloud Settings](./media/ipados_system_settings.png)

4. Turn on **Keychain** if it isn't already on.

![iPadOS iCloud Settings for Keychain](./media/ipados_icloud.png)

![iPadOS iCloud Keychain Settings](./media/ipados_keychain.png)
...
![Third Party Passwords - Settings Menu](./media/password_management_3rd_party_settings_menu.png)

![Third Party Passwords - Use Orion's Keychain](./media/password_management_use_orions_keychain.png)

Now, to access your Safari passwords simply click the key icon in the login screen of your favorite website.

![Third Party Passwords - Key Button](./media/password_management_3rd_party_key_button.png)

Then, click the **Passwords** button.

![Third Party Passwords - Passwords Button](./media/password_management_3rd_party_passwords_button.png)


Next, you will be prompted to unlock your passwords with **Touch ID** or with your **macOS password**.

![Third Party Passwords - Unlock Passwords](./media/password_management_3rd_party_unlock_passwords.png)

Finally, select the desired password from the list and click on **Choose Password**.

![Third Party Passwords - Choose Password](./media/password_management_3rd_party_choose_password.png)
