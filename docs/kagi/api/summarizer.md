...
Universal Summarizer API uses pre-paid API credits. You can manage API credits in the [API billing](https://kagi.com/settings/billing_api) page of your Kagi settings.
