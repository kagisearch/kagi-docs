...
![Kagi Maps - Geolocation Button](./media/kagi-maps-location-button.png){data-zoomable}

Your browser will prompt you to grant Kagi Maps permission to access your location using its built-in geolocation system. 

![Kagi Maps - Geolocation Options](./media/kagi-maps-location-prompt.png){data-zoomable}
