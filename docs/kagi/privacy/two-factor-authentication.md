...
![2FA authentication - Get Started](./media/2fa_auth_get_started.png)

On the next screen, a QR code will be displayed. You can scan this QR code from your favorite authenticator app.

![2FA authentication - QR code](./media/2fa_auth_qr_code.png)
...
![2FA authentication - Manual Configuration](./media/2fa_auth_manual_configuration.png)
...
![2FA authentication - Manual Configuration](./media/2fa_auth_backup_codes.png)
...
![2FA authentication - Finish setup](./media/2fa_auth_verify.png)
...
![2FA authentication - Login](./media/2fa_auth_login.png)
...
![2FA authentication - Login](./media/2fa_auth_remove_2fa.png)
