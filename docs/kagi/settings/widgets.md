...
- **Dice**: Choose whether the Dice widget will appear in results. This widget rolls virtual dice inline with the results page.
- **Flip Coins**: Choose whether the Flip Coins widget will appear in results. This widget flips a virtual coin inline with the results page.
- **Sports**: Choose whether the Sports widget will appear in results. This widget shows live scores, dates, and standings for teams and leagues.
